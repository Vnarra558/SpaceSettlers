...
public class MoveFastAction extends AbstractAction{
    /**
     ...
     */
    public MoveFastAction(Toroidal2DPhysics space, Position currentLocation,
        ...
        KvRotational = 2.53;
        KpRotational = 1.6;
        KvTranslational = 1.8f;
        KpTranslational = 1.05f;
    }
